...
{
    public class IMTAppTest : DemoScriptBase
    {
        ...
        {
            { AppState.InitSession,new DemoStepParams() { StepMessage = "Initialize Edit Skip", StepColor = Color.clear }},
            ...
            { AppState.DemoLoading,new DemoStepParams() { StepMessage = "Processing...", StepColor = Color.clear }}
        };
        ...
        public async override Task AdvanceDemoAsync()
        {
            switch (currentAppState)
            {
                ...
                case AppState.DemoStepCreateLocalAnchor:
                    currentAppState = AppState.DemoStepBusy; //test
                    //hololens: automatically places anchors for some reason
                    //thinks that its clicking/tapping surface constantly?
                    //spawnedObject = null;
                    //formMenu.SetActive(false); //test
                    //currentAppState = AppState.DemoStepBusy;
                    //Debug.Log(isSpawned);
                ...
                case AppState.EditAnchor:
                    ...
                    */
                    ...
                    //hololens: automatically places anchors for some reason.
                    spawnedObject = null;
                    currentAppState = AppState.DemoLoading;
                    break;
                //loading for next set of anchors
                case AppState.DemoLoading:
                    formMenu.SetActive(false);
                    //currentAppState = AppState.DemoStepBusy;
                    currentAppState = AppState.DemoStepCreateLocalAnchor;
                    //await AdvanceDemoAsync();
                ...
                case AppState.DemoStepLookingForAnchor:
                    //go back to anchor creation state afterwards
                    isSpawned = false;
                    currentAppState = AppState.DemoStepCreateLocalAnchor;
                    break;
