...
{
    public class IMTTempTest : DemoScriptBase
    {
        ...
        private readonly Dictionary<AppState, DemoStepParams> stateParams = new Dictionary<AppState, DemoStepParams>
        {
            ...
            { AppState.EditAnchor,new DemoStepParams() { StepMessage = "Next: Anchor Editing (Cancel, Delete or Save)", StepColor = Color.grey }},
